...
```
```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ahs-lab.vercel.app/r/TypeWriterEffect.json
```

```bash tab="bun"
bunx --bun shadcn@latest add https://ahs-lab.vercel.app/r/TypeWriterEffect.json
```
