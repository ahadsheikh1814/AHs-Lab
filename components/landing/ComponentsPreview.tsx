  ...
  return (
    <div className="mt-20">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10">
        ...
        <ButtonsDarkToLight className="flex justify-center items-center group">Browse Components <span className="mt-1 mx-2 group-hover:ml-5 transition-all duration-200"><MoveRightIcon/></span> </ButtonsDarkToLight>
        </div>
      </div>
    </div>
  );
