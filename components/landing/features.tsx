...
const Features = () => {
  return (
    <div className="flex flex-col md:px-10 px-5 py-10">
        <div>
          <h3 className="pb-2 text-sm font-semibold uppercase tracking-wide text-neutral-600">
            OUR VALUES
          </h3>
          <H2 className="">
            Why{" "}
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3 md:w-[80%]">
          <motion.div 
